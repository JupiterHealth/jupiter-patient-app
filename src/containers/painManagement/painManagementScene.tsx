...
import AssessmentButtonComponent from "./assessmentButtonComponent";

export interface PainManagementSceneProps {
...
const PainManagementScene = (props: PainManagementSceneProps) => {
    ...
    return (
        <div>
            {/* CustomerStepper */}
            <div
                className={`md:pt-10 md:mt-0 pb-3 md:pb-14 w-full ${painManagementStyles.customStepper}`}
            >
                <div className="!bg-[#f9f9f9] w-full flex items-center justify-between lg:hidden landscapeBack bg-transparent py-2">
                    ...
                    <div
                        className={`text-base bg-white text-white shadow-lg p-3 w-[30px] h-[30px] md:w-[15px] md:h-[15px] lg:w-[30px] lg:h-[30px] rounded-full flex items-center justify-center landscapeClose ${painManagementStyles.closeOutlined}`}
                    >
                        <Tooltip
                            placement="bottom"
                ...
                <div className="flex items-start justify-center container mx-auto relative rounded-[10px] md:rounded-none pt-5 md:pt-0 pb-12 md:pb-0 bg-white md:bg-none">
                    ...
                    <div
                        className={`hidden text-base absolute top-[-30px] right-[7px] bg-white text-white shadow-lg p-3 w-[30px] h-[30px] md:w-[15px] md:h-[15px] lg:w-[30px] lg:h-[30px] rounded-full md:flex items-center justify-center ${painManagementStyles.closeOutlined}`}
                    >
                        <Tooltip
                            placement="bottom"
                            title={"Close Assessment"}
            ...
            {loadingState?.checkAssessMent && (
                <div className={painManagementStyles.defaultSkeleton}>
                    <DefaultSkeleton />
                </div>
            )}
            {/* Container */}
                ...
                <div
                    ...
                    ${
                        [
                            ...
                            ? painManagementStyles.painManagementContentCustom
                            : painManagementStyles.painManagementContent
                    }
...
export default PainManagementScene;
