...
import maleSexualHealthStyle from "./maleSexualHealthQuizStyle.module.scss";
...
const steps = [
    ...
    {
        title: "Male Sexual Health Questions",
...
const MaleSexualHealthQuizScene = () => {
    ...
    return (
        <div>
            <div className={maleSexualHealthStyle.customStepper}>
                <Steps
                    current={current}
...
export default MaleSexualHealthQuizScene;
