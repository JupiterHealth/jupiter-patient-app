...
import antiAgingStyle from "./antiAgingStyles.module.scss";
...
const AntiAgingHealthScene = () => {
    ...
    return (
        <>
            <div>
                <div className={antiAgingStyle.customStepper}>
                    <Steps
                        current={current}
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="mt-6">
                            <p className="text-lg font-medium text-light-black">
                                By clicking “Begin assessment”, you are agreeing
                                to the <br />
...
export default AntiAgingHealthScene;
