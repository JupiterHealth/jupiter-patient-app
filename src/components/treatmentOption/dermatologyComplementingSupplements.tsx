...
export interface DermatologyComplementingSupplementsProps {
...
const DermatologyComplementingSupplements = (
    props: DermatologyComplementingSupplementsProps,
) => {
    const {
        selectedTreatment,
...
export default DermatologyComplementingSupplements;
