...
export interface SexualActivityModalProps {
    isOpen?: boolean;
    onClose?: (data?: any) => void;
    footer?: boolean;
}

const SexualActivityModal = (props: SexualActivityModalProps) => {
    const { isOpen, onClose, footer } = props;
    return (
        <>
            <Modal width={800} open={isOpen} onCancel={onClose} footer={false}>
                <h1 className="text-2xl font-bold text-secondary">
                    Sexual Activity Limit
                </h1>
                <hr className="my-7" />
...
export default SexualActivityModal;
