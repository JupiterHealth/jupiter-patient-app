...
export interface SurgeryImplantModalProps {
    isOpen?: boolean;
    onClose?: (data?: any) => void;
    footer?: boolean;
}

const SurgeryImplantModal = (props: SurgeryImplantModalProps) => {
    const { isOpen, onClose, footer } = props;
    return (
        <>
            <Modal width={800} open={isOpen} onCancel={onClose} footer={false}>
                <h1 className="text-2xl font-bold text-secondary">
                    Undergone selected surgeries or implants
                </h1>
                <hr className="my-5" />
...
export default SurgeryImplantModal;
